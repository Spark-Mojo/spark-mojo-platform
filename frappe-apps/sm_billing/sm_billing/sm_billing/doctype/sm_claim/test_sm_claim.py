...
# Restore sys.modules immediately after importing SMClaim.
# SMClaim's module-level 'import frappe' already bound the mock; the mock
# stays in sm_claim's namespace and tests still work. But bench run-tests
